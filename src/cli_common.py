...
# HEADER'ом. С запасом на живой звук: тишина quiet_gap_s у приёмника +
# сам ответ в воздухе. Приёмник после успеха обязан дослушивать ДОЛЬШЕ
# этого срока (serve_done_after_success), иначе пинг прилетит в пустоту.
RESPONSE_WAIT_S = 12.0
